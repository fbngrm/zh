...
func NewDict(parser *Parser, sourceName, sourcePath string) (Dict, error) {
	parsedSentences, _, err := parser.ParseFromFile(sourceName, sourcePath, SPLIT_MODE_CUTTER, true)
	if err != nil {
		return nil, err
	}
